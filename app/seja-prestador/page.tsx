        ...
        <section className="flex flex-col items-center justify-center space-y-20 h-dvh bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 py-16 md:py-24 text-white">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed opacity-90">
              Transforme suas habilidades em renda. Conecte-se com milhares de
              clientes que precisam dos seus serviços.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Aumente sua renda oferecendo seus serviços para milhares de
                  clientes
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Acesso a uma base de clientes verificados e interessados em
                  seus serviços
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Ferramentas para fazer seu negócio crescer e se destacar no
                  mercado
                </p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Crie seu perfil profissional com suas informações e
                  especialidades
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Realize os serviços e aumente sua renda mensal
                </p>
              </div>
            </div>
          </div>
